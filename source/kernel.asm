;AquaSeven --- The VIRUS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE VIRUSOS_VER '1.0.0'	 ;OS version number
	%DEFINE VIRUSOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to VIRUS OS****************************', 0
	os_version_msg		db 'Version ', VIRUSOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', VIRUSOS_VER, 0

	dialog_string_1		db 'Welcome to Virus Operating System', 0
